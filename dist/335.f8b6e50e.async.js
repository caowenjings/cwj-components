!(function () {
  ...
  var Y1 = (Le, I, H) =>
      I in Le
        ? yl(Le, I, { enumerable: !0, configurable: !0, writable: !0, value: H })
        : (Le[I] = H),
    J1 = (Le, I) => {
  ...
  var Ds = (Le, I) => {
    ...
    if (Le != null && Mn)
      for (var u of Mn(Le)) I.indexOf(u) < 0 && z1.call(Le, u) && (H[u] = Le[u]);
    return H;
  };
    ...
    [335],
    {
      92509: function (Le, I, H) {
        (function (u, e) {
          ...
          const q = ($, U, G, M, pe, ue, re, N) => Ae(!0, $, U, G, M, pe, ue, re, N),
            oe = ($, U) => de(!0, $, U);
          function ie($, U, G) {
          ...
          function ye($, U, G = !0) {
            const { _sources: M, _sourcesContent: pe, _ignoreList: ue } = $,
              re = e.put(M, U);
            re === pe.length && (pe[re] = null), G ? e.put(ue, re) : e.remove(ue, re);
          }
          function ve($) {
            const {
              _mappings: U,
          ...
          function P($) {
            const U = ve($);
            return Object.assign(Object.assign({}, U), { mappings: Ie.encode(U.mappings) });
          }
          function Se($) {
            ...
            return (
              ...
              (G._sourcesContent = U.sourcesContent || U.sources.map(() => null)),
          ...
          function Ae($, U, G, M, pe, ue, re, N, se) {
            const { _mappings: Ne, _sources: b, _sourcesContent: S, _names: L } = U,
              D = Fe(Ne, G),
              z = qe(D, M);
            ...
            const ae = e.put(b, pe),
              _ = N ? e.put(L, N) : -1;
            if (
              (ae === S.length && (S[ae] = se != null ? se : null), !($ && v(D, z, ae, ue, re, _)))
            )
          ...
          function v($, U, G, M, pe, ue) {
            ...
            return re.length === 1
              ? !1
              : G === re[1] && M === re[2] && pe === re[3] && ue === (re.length === 5 ? re[4] : -1);
          }
          function de($, U, G) {
            const { generated: M, source: pe, original: ue, name: re, content: N } = G;
            return pe
              ? Ae($, U, M.line - 1, M.column, pe, ue.line - 1, ue.column, re, N)
      ...
      48435: function (Le) {
        (function (I, H) {
          ...
          function d(q) {
            const oe = u.exec(q),
              ie = oe[2];
            return T('file:', '', oe[1] || '', '', O(ie) ? ie : '/' + ie, oe[3] || '', oe[4] || '');
          }
          ...
          function E(q) {
            ...
            return (
              (oe.scheme = ''),
              (oe.host = ''),
              (oe.type = q ? (q.startsWith('?') ? 3 : q.startsWith('#') ? 2 : 4) : 1),
              oe
            );
          }
          function j(q) {
          ...
          function r(q, oe) {
            w(oe, oe.type), q.path === '/' ? (q.path = oe.path) : (q.path = j(oe.path) + q.path);
          }
          function w(q, oe) {
            const ie = oe <= 4,
              ye = q.path.split('/');
          ...
          function ce(q, oe) {
            ...
            switch (ye) {
              ...
              case 4: {
                ...
                return P ? (C(oe || q) && !C(P) ? './' + P + ve : P + ve) : ve || '.';
              }
              case 5:
                return ie.path + ve;
              default:
                return ie.scheme + '//' + ie.user + ie.host + ie.port + ie.path + ve;
            }
          }
          return ce;
        });
      ...
      92297: function (Le, I, H) {
        ...
        (function (e, Ie) {
          ...
          const j = 1024 * 16,
            r =
              typeof TextDecoder != 'undefined'
                ...
                ? {
                    decode(K) {
                      return u.from(K.buffer, K.byteOffset, K.byteLength).toString();
                    },
                  }
                : {
                    decode(K) {
                      let R = '';
                      for (let m = 0; m < K.length; m++) R += String.fromCharCode(K[m]);
                      return R;
                    },
                  };
          class w {
            ...
            write(R) {
              const { buffer: m } = this;
              (m[this.pos++] = R), this.pos === j && ((this.out += r.decode(m)), (this.pos = 0));
            }
            flush() {
          ...
          function ye(K, R, m, v) {
            ...
            R > 0 && m.write(44), (v[0] = T(m, $, v[0])), T(m, U, 0), T(m, pe, 0);
          ...
          function ve(K) {
            ...
            do {
              ...
              for (; m.pos < se; m.pos++) {
                ...
                if (S) {
                  const me = d(m, U);
                  (G = d(m, U === me ? G : 0)), (U = me), (_ = [$, Ne, 0, 0, me, G]);
                } else _ = [$, Ne, 0, 0];
                if (((_.isScope = !!D), L)) {
                  const me = M,
                    Re = pe;
                  M = d(m, M);
                  const Q = me === M;
                  (pe = d(m, Q ? pe : 0)), (ue = d(m, Q && Re === pe ? ue : 0)), (z = [M, pe, ue]);
                }
          ...
          function P(K) {
            ...
            const R = new w();
            for (let m = 0; m < K.length; ) m = Se(K, m, R, [0, 0, 0, 0, 0, 0, 0]);
            return R.flush();
          }
          function Se(K, R, m, v) {
            const de = K[R],
              { 0: $, 1: U, 2: G, 3: M, isScope: pe, callsite: ue, bindings: re } = de;
            v[0] < $ ? (Ce(m, v[0], $), (v[0] = $), (v[1] = 0)) : R > 0 && m.write(44),
              (v[1] = T(m, de[1], v[1]));
            const N = (de.length === 6 ? 1 : 0) | (ue ? 2 : 0) | (pe ? 4 : 0);
            if ((T(m, N, 0), de.length === 6)) {
              const { 4: se, 5: Ne } = de;
              se !== v[2] && (v[3] = 0), (v[2] = T(m, se, v[2])), (v[3] = T(m, Ne, v[3]));
            }
            if (ue) {
              const { 0: se, 1: Ne, 2: b } = de.callsite;
              se !== v[4] ? ((v[5] = 0), (v[6] = 0)) : Ne !== v[5] && (v[6] = 0),
                (v[4] = T(m, se, v[4])),
                (v[5] = T(m, Ne, v[5])),
                (v[6] = T(m, b, v[6]));
            }
                ...
                (de = d(m, de)),
                  ...
                  E(m, pe)
                    ? (($ = d(m, $)),
                      (U = d(m, U)),
                      (G = d(m, G)),
                      E(m, pe) ? ((M = d(m, M)), (se = [de, $, U, G, M])) : (se = [de, $, U, G]))
                    : (se = [de]),
                  ue.push(se),
                  m.pos++;
              }
      ...
      83446: function (Le, I, H) {
        (function (u, e) {
          ...
          function q(l) {
            for (let p = 1; p < l.length; p++) if (l[p][C] < l[p - 1][C]) return !1;
            return !0;
          }
          function oe(l, p) {
          ...
          function Ae(l, p, g, y) {
            ...
            return (g.lastKey = y), (g.lastNeedle = p), (g.lastIndex = ve(l, p, Ee, le));
          }
          function Fe(l, p) {
            const g = p.map(Ke);
            ...
            for (let Ue = 0; Ue < je.length; Ue++) {
              ...
              if (Ue + 1 < je.length) {
                ...
                (gt = Math.min(J, Ee + _t.line)),
                  gt === J ? (bt = Math.min(Ge, le + _t.column)) : gt < J && (bt = le + _t.column);
              }
            ...
            for (let nt = 0; nt < gt.length; nt++) {
              ...
              for (let Nt = 0; Nt < hn.length; Nt++) {
                ...
                const pn = ze + yt[h],
                  mn = yt[d],
                  dn = yt[T];
                zt.push(yt.length === 4 ? [Rt, pn, mn, dn] : [Rt, pn, mn, dn, at + yt[E]]);
              }
            }
          }
          function de(l, p) {
          ...
          class ue {
            constructor(p, g) {
              ...
              (this.version = W),
                ...
                (this.ignoreList = Y.ignoreList || Y.x_google_ignoreList || void 0);
              const je = O(le || '', X(g));
          ...
          function b(l, p) {
            ...
            return x(Ge[le[h]], le[d] + 1, le[T], le.length === 5 ? J[le[E]] : null);
          }
          function S(l, p) {
            ...
            for (let W = 0; W < g.length; W++) {
              ...
              for (let Ee = 0; Ee < he.length; Ee++) {
                ...
                let je = null,
                  ...
                  ze = null,
                  at = null;
                le.length !== 1 && ((je = Y[le[1]]), (Ue = le[2] + 1), (ze = le[3])),
          ...
          function a(l, p, g, y, Y, W) {
            ...
            let J = Ee.indexOf(p);
            if ((J === -1 && (J = le.indexOf(p)), J === -1)) return W ? [] : Oe(null, null);
            const je = ((he = l)._bySources ||
              (he._bySources = Fe(se(l), (l._bySourceMemos = Ee.map(Ce)))))[J][g];
      ...
      37335: function (Le, I, H) {
        ...
        class O {
          constructor(n, s, c) {
            (this.startTokenIndex = n), (this.endTokenIndex = s), (this.isFunctionScope = c);
          }
        }
        class X {
        ...
        class C {
          ...
          restoreFromSnapshot(n) {
            (this.potentialArrowAt = n.potentialArrowAt),
              ...
              (this.inDisallowConditionalTypesContext = n.inDisallowConditionalTypesContext),
        ...
        function ye(t) {
          let n = 1,
            s = 1;
          for (let c = 0; c < t; c++) w.charCodeAt(c) === h.lineFeed ? (n++, (s = 1)) : s++;
          return new ie(n, s);
        }
        function ve(t, n, s, c) {
        ...
        function qe() {
          ...
          for (let s = n; s < r.start; s++) {
            ...
            if (c === h.lineFeed || c === h.carriageReturn || c === 8232 || c === 8233) return !0;
          }
          return !1;
        }
        function Ke() {
        ...
        function re() {
          ...
          for (
            ;
            s < w.length && ((n = w.charCodeAt(s)), !(n < h.lowercaseA || n > h.lowercaseZ));
          ...
          for (; s < w.length; ) {
            ...
            if (M[f]) s++;
              ...
              if (((s += 2), w.charCodeAt(s) === h.leftCurlyBrace)) {
                for (; s < w.length && w.charCodeAt(s) !== h.rightCurlyBrace; ) s++;
                s++;
              }
            } else if (f === h.atSign && w.charCodeAt(s + 1) === h.atSign) s += 2;
            else break;
          }
          (r.pos = s), J(e.name);
        }
        ...
        (function (t) {
          ...
          const A = k + 1;
          t[(t.ObjectShorthandTopLevelDeclaration = A)] = 'ObjectShorthandTopLevelDeclaration';
          const B = A + 1;
        ...
        function D(t) {
          const n = t.identifierRole;
          return (
            n === N.FunctionScopedDeclaration || n === N.ObjectShorthandFunctionScopedDeclaration
          );
        }
        function z(t) {
          return (
        ...
        function Q(t) {
          for (let s = r.tokens.length - t; s < r.tokens.length; s++) r.tokens[s].isType = !0;
          const n = r.isType;
          return (r.isType = !0), n;
        }
        function te(t) {
        ...
        function W(t) {
          pe[t] || t === h.backslash || (t === h.atSign && w.charCodeAt(r.pos + 1) === h.atSign)
            ? re()
            : zt(t);
        }
        function he() {
          for (; w.charCodeAt(r.pos) !== h.asterisk || w.charCodeAt(r.pos + 1) !== h.slash; )
        ...
        function je() {
          w.charCodeAt(r.pos + 1) === h.equalsTo ? Pe(e.assign, 2) : Pe(e.slash, 1);
        }
        function Ue(t) {
          ...
          t === h.asterisk &&
            ...
            c === h.equalsTo && w.charCodeAt(r.pos + 2) !== h.greaterThan && (s++, (n = e.assign)),
            Pe(n, s);
        }
        function ze(t) {
        ...
        function at() {
          w.charCodeAt(r.pos + 1) === h.equalsTo ? Pe(e.assign, 2) : Pe(e.bitwiseXOR, 1);
        }
        function gt(t) {
          const n = w.charCodeAt(r.pos + 1);
          if (n === t) {
          ...
          n === h.equalsTo ? Pe(e.assign, 2) : t === h.plusSign ? Pe(e.plus, 1) : Pe(e.minus, 1);
        }
        function bt() {
          const t = w.charCodeAt(r.pos + 1);
          if (t === h.lessThan) {
        ...
        function zt(t) {
          switch (t) {
            ...
            case h.rightCurlyBrace:
              ...
              return;
            case h.colon:
              w.charCodeAt(r.pos + 1) === h.colon ? Pe(e.doubleColon, 2) : (++r.pos, J(e.colon));
              return;
            case h.questionMark:
              Xt();
              return;
        ...
        function yt() {
          ...
          w.charCodeAt(r.pos) === h.lowercaseN ? (++r.pos, J(e.bigint)) : J(e.num);
        }
        function Rt(t) {
          let n = !1,
            s = !1;
          ...
          if (
            ...
            (c === h.uppercaseE || c === h.lowercaseE) &&
              ...
              Nt(),
              (c = w.charCodeAt(r.pos))),
            c === h.lowercaseN ? (++r.pos, (n = !0)) : c === h.lowercaseM && (++r.pos, (s = !0)),
            n)
          ) {
            J(e.bigint);
            return;
        ...
        function mn() {
          for (;;) {
            ...
            if (
              t === h.graveAccent ||
              (t === h.dollarSign && w.charCodeAt(r.pos + 1) === h.leftCurlyBrace)
            ) {
          ...
          for (; r.pos < w.length; ) {
            ...
            if (M[t]) r.pos++;
              ...
              if (((r.pos += 2), w.charCodeAt(r.pos) === h.leftCurlyBrace)) {
                for (; r.pos < w.length && w.charCodeAt(r.pos) !== h.rightCurlyBrace; ) r.pos++;
                r.pos++;
              }
            } else break;
          }
        ...
        function Jt(t, n = t.currentIndex()) {
          ...
          if ((s++, kn(t, s))) return { isType: !0, leftName: null, rightName: null, endIndex: s };
          if ((s++, kn(t, s)))
            return {
              isType: !1,
        ...
        class Pt extends ut {
          ...
          process() {
            return this.tokens.matches1(e.jsxTagStart) ? (this.processJSXTag(), !0) : !1;
          }
          getPrefixCode() {
            let n = '';
            if (
              ...
              if (this.importProcessor)
                for (const [c, f] of Object.entries(this.cjsAutomaticModuleNameResolutions))
                  n += `var ${f} = require("${c}");`;
              else {
                const s = this.esmAutomaticImportNameResolutions,
                  { createElement: c } = s,
                  f = Ds(s, ['createElement']);
                c && (n += `import {createElement as ${c}} from "${this.jsxImportSource}";`);
          ...
          processJSXTag() {
            const { jsxRole: n, start: s } = this.tokens.currentToken(),
              c = this.options.production ? null : this.getElementLocationCode(s);
...
` && this.lastLineNumber++,
          ...
          transformTagToJSXFunc(n, s) {
            ...
            for (
              this.options.production ||
                ...
                this.tokens.appendCode(`, ${c}, ${this.getDevSource(n)}, this`)),
          ...
          transformTagToCreateElement(n) {
            ...
            for (this.tokens.removeInitialToken(); !this.tokens.matches1(e.jsxTagEnd); )
              this.tokens.removeToken();
            this.tokens.replaceToken(')');
          }
          getJSXFuncInvocationCode(n) {
            return this.options.production
              ...
              : this.claimAutoImportedFuncInvocation('jsxDEV', '/jsx-dev-runtime');
          }
          getCreateElementInvocationCode() {
              ...
              return this.claimAutoImportedFuncInvocation('createElement', '');
            {
              ...
              return `${
                (this.importProcessor && this.importProcessor.getIdentifierReplacement(n.base)) ||
                n.base
              }${n.suffix}(`;
            }
          }
              ...
              );
            {
              ...
              return (
                ((this.importProcessor &&
                  this.importProcessor.getIdentifierReplacement(n.fragmentBase)) ||
            ...
            if (this.importProcessor) {
              ...
              return (
                this.esmAutomaticImportNameResolutions[n] ||
                  (this.esmAutomaticImportNameResolutions[n] = this.nameManager.claimFreeName(
                    `_${n}`,
                  )),
                this.esmAutomaticImportNameResolutions[n]
              );
          ...
          processPropsObjectWithDevInfo(n) {
            ...
            if (!this.tokens.matches1(e.jsxName) && !this.tokens.matches1(e.braceL)) {
              ...
              if (this.tokens.matches2(e.jsxName, e.eq)) {
                ...
                if (n && c === 'key') {
                  ...
                  this.processPropValue(),
                    (s = this.tokens.dangerouslyGetAndRemoveCodeSinceSnapshot(f));
                  continue;
                } else
                  this.processPropName(c), this.tokens.replaceToken(': '), this.processPropValue();
          ...
          processChildren(n) {
            ...
            for (;;) {
              ...
              if (this.tokens.matches1(e.braceL))
                ...
                this.tokens.appendCode(s ? ', ' : ''), this.processJSXTag(), (c = !0);
              else if (this.tokens.matches1(e.jsxText) || this.tokens.matches1(e.jsxEmptyText))
...
`
              ...
              if (/\s/.test(t[s + 1])) for (n += ' '; s < t.length && /\s/.test(t[s + 1]); ) s++;
              else
                n += `
`;
            else if (c === '&') {
        ...
        function js(t, n) {
          ...
          if (t[k] === '#') {
            ...
            k++;
            let B;
            if (t[k] === 'x') for (A = 16, k++, B = k; k < t.length && no(t.charCodeAt(k)); ) k++;
        ...
        class Lt {
          ...
          generateImportReplacements() {
            for (const [n, s] of this.importInfoByPath.entries()) {
              ...
              if (f.length > 0)
                for (const ne of f) {
                  const we = this.enableLegacyTypeScriptModuleInterop
                    ? fe
                    : `${this.helperManager.getHelperName('interopRequireWildcard')}(${fe})`;
                  ge += ` var ${ne} = ${we};`;
                }
              else
                B.length > 0 && be !== fe
              ...
              ee && (ge += ` ${this.helperManager.getHelperName('createStarExport')}(${fe});`),
                this.importsToReplace.set(n, ge);
              for (const ne of c) this.identifierReplacements.set(ne, `${be}.default`);
          ...
          preprocessImportAtIndex(n) {
            ...
            if (
              ...
              for (const ee of B.namedImports)
                ee.importedName === 'default' ? s.push(ee.localName) : f.push(ee);
            }
            if (
            ...
            A.defaultNames.push(...s),
              ...
              s.length === 0 && c.length === 0 && f.length === 0 && (A.hasBareImport = !0);
          }
          preprocessExportAtIndex(n) {
            ...
            } else if (this.tokens.matches3AtIndex(n, e._export, e.name, e._function)) {
            ...
            for (let c = n + 2; ; c++)
              if (
                ...
                if (this.tokens.matches1AtIndex(1, e.eq)) {
                  ...
                  if (f == null) throw new Error('Expected = token with an end index.');
                  c = f - 1;
                } else {
          ...
          preprocessNamedExportAtIndex(n) {
            ...
            if (((n = s), this.tokens.matchesContextualAtIndex(n, u._from))) n++;
            else {
              for (const { importedName: A, localName: B } of c) this.addExportBinding(A, B);
              return;
            }
          ...
          preprocessExportStarAtIndex(n) {
            ...
            if (
              (this.tokens.matches3AtIndex(n, e._export, e.star, e._as)
                ? ((n += 3), (s = this.tokens.identifierNameAtIndex(n)), (n += 2))
                : (n += 3),
              !this.tokens.matches1AtIndex(n, e.string))
            )
          ...
          getNamedImports(n) {
            ...
            for (;;) {
              ...
              if (
                ((n = c.endIndex),
                c.isType || s.push({ importedName: c.leftName, localName: c.rightName }),
          ...
          addExportBinding(n, s) {
            this.exportBindingsByLocalName.has(n) || this.exportBindingsByLocalName.set(n, []),
          ...
          resolveExportBinding(n) {
            ...
            return !s || s.length === 0 ? null : s.map((c) => `exports.${c}`).join(' = ');
          }
          getGlobalNames() {
            return new Set([
        ...
        function ro({ code: t, mappings: n }, s, c, f, k) {
          ...
          for (let He = 0; He < t.length; He++) {
            ...
            t.charCodeAt(He) === h.lineFeed &&
              (be++, (ge = He + 1), fe !== ge && (0, Qt.maybeAddSegment)(B, be, 0, s, be, 0));
          }
  ...
  `,
        ...
        class gn {
          ...
          constructor(n) {
            (this.nameManager = n), gn.prototype.__init.call(this), gn.prototype.__init2.call(this);
          }
          getHelperName(n) {
            let s = this.helperNames[n];
            return (
              s || ((s = this.nameManager.claimFreeName(`_${n}`)), (this.helperNames[n] = s), s)
            );
          }
          emitHelpers() {
            let n = '';
            this.helperNames.optionalChainDelete && this.getHelperName('optionalChain'),
              this.helperNames.asyncOptionalChainDelete && this.getHelperName('asyncOptionalChain');
            for (const [s, c] of Object.entries(oo)) {
              const f = this.helperNames[s];
              let k = c;
              s === 'optionalChainDelete'
                ? (k = k.replace('OPTIONAL_CHAIN_NAME', this.helperNames.optionalChain))
                : s === 'asyncOptionalChainDelete'
                ? (k = k.replace('ASYNC_OPTIONAL_CHAIN_NAME', this.helperNames.asyncOptionalChain))
                : s === 'require' &&
                  (this.createRequireName === null &&
                    (this.createRequireName = this.nameManager.claimFreeName('_createRequire')),
                  (k = k.replace(/CREATE_REQUIRE_NAME/g, this.createRequireName))),
                f && ((n += ' '), (n += k.replace(s, f).replace(/\s+/g, ' ').trim()));
            }
            return n;
          }
        }
        ...
        function io(t, n) {
          for (const s of t.tokens)
            if (s.type === e.name && !s.isType && b(s) && n.has(t.identifierNameForToken(s)))
              return !0;
          return !1;
        }
        function ao(t, n, s) {
          ...
          for (let k = t.tokens.length - 1; ; k--) {
            for (; c.length > 0 && c[c.length - 1].startTokenIndex === k + 1; ) c.pop();
            ...
            if (c.length > 1 && !A.isType && A.type === e.name && s.has(B)) {
              if (L(A)) $s(c[c.length - 1], t, B);
                ...
                if (ee < 0) throw new Error('Did not find parent function scope.');
                $s(c[ee], t, B);
              }
            }
          }
        ...
        function co(t, n) {
          const s = [];
          for (const c of n) c.type === e.name && s.push(t.slice(c.start, c.end));
          return s;
        }
        class Bn {
          __init() {
          ...
          constructor(n, s) {
            Bn.prototype.__init.call(this), (this.usedNames = new Set(co(n, s)));
          }
          claimFreeName(n) {
        ...
        const lo = Me.union(
          ...
          fo = Me.iface([], {
            ...
            jsxRuntime: Me.opt(
              Me.union(Me.lit('classic'), Me.lit('automatic'), Me.lit('preserve')),
            ),
        ...
        function _n() {
          xe(), (r.tokens[r.tokens.length - 1].identifierRole = N.ImportDeclaration);
        }
        function jn(t) {
          let n;
          r.scopeDepth === 0
        ...
        function ko(t, n) {
          t && $n([u._public, u._protected, u._private, u._readonly, u._override]),
            xn(n),
            Hs(),
            xn(n, !0);
        }
        ...
        function Gs() {
          ...
          return (
            _(),
            (o(e.bracketL) || o(e.braceL) || o(e.star) || o(e.ellipsis) || o(e.hash) || go()) &&
            !qe()
              ? !0
        ...
        function wo() {
          m(e._typeof), o(e._import) ? Xs() : Zt(), !qe() && o(e.lessThan) && Vt();
        }
        function Xs() {
          m(e._import),
            m(e.parenL),
        ...
        function Io() {
          ...
          const t = x(e._in),
            n = Ce(u._out);
          x(e._const),
            (t || n) && !o(e.name) ? (r.tokens[r.tokens.length - 1].type = e.name) : xe(),
            x(e._extends) && $e(),
            x(e.eq) && $e();
        }
        function Dt() {
        ...
        function Vn(t) {
          const n = t === e.arrow;
          Dt(), m(e.parenL), r.scopeDepth++, bo(!1), r.scopeDepth--, (n || o(t)) && Kt(t);
        }
        function bo(t) {
          qn(e.parenR, t);
        }
        ...
        function Js() {
          ...
          const t = Q(0);
          return m(e.bracketL), xe(), en(), m(e.bracketR), Ut(), In(), te(t), !0;
        }
        function Qs(t) {
          x(e.question), !t && (o(e.parenL) || o(e.lessThan)) ? (Vn(e.colon), In()) : (Ut(), In());
        }
        function Eo() {
        ...
        function vo() {
          return (
            ...
            x(e.plus) || x(e.minus)
              ? P(u._readonly)
              : (P(u._readonly) && _(), !o(e.bracketL) || (_(), !Un()) ? !1 : (_(), o(e._in)))
          );
        }
        function Co() {
          xe(), m(e._in), $e();
        ...
        function Do() {
          for (me(), me(); !o(e.backQuote) && !r.error; ) m(e.dollarBraceL), $e(), me(), me();
          _();
        }
        var Et;
        (function (t) {
        ...
        function Wn(t) {
          t === Et.TSAbstractConstructorType && Ae(u._abstract),
            (t === Et.TSConstructorType || t === Et.TSAbstractConstructorType) && m(e._new);
        ...
        function Oo() {
          for (Fo(); !qe() && x(e.bracketL); ) x(e.bracketR) || ($e(), m(e.bracketR));
        }
        function Mo() {
          if ((Ae(u._infer), xe(), o(e._extends))) {
            ...
            (r.inDisallowConditionalTypesContext = !0),
              $e(),
              (r.inDisallowConditionalTypesContext = n),
              (r.error || (!r.inDisallowConditionalTypesContext && o(e.question))) &&
        ...
        function Ks() {
          if ((x(e.bitwiseAND), Hn(), o(e.bitwiseAND))) for (; x(e.bitwiseAND); ) Hn();
        }
        function Bo() {
          if ((x(e.bitwiseOR), Ks(), o(e.bitwiseOR))) for (; x(e.bitwiseOR); ) Ks();
        }
        function jo() {
        ...
        function qo() {
          ...
          if (o(e.braceL) || o(e.bracketL)) {
            let t = 1;
            for (_(); t > 0 && !r.error; )
              o(e.braceL) || o(e.bracketL) ? t++ : (o(e.braceR) || o(e.bracketR)) && t--, _();
            return !0;
          }
          return !1;
        }
          ...
          return P(u._asserts)
            ? (_(),
              Ce(u._is)
                ...
                : (r.restoreFromSnapshot(t), !1))
            : Un() || o(e._this)
            ? (_(), P(u._is) && !qe() ? (_(), $e(), !0) : (r.restoreFromSnapshot(t), !1))
            : !1;
        }
        function en() {
          const t = Q(0);
        ...
        function $e() {
          if ((e1(), r.inDisallowConditionalTypesContext || qe() || !x(e._extends))) return;
          const t = r.inDisallowConditionalTypesContext;
          (r.inDisallowConditionalTypesContext = !0),
            e1(),
            (r.inDisallowConditionalTypesContext = t),
        ...
        function Gn() {
          for (Tt(!1), m(e.braceL); !x(e.braceR) && !r.error; ) Zo(), x(e.comma);
        }
        function Yn() {
        ...
        function n1() {
          P(u._global) ? xe() : o(e.string) ? xt() : v(), o(e.braceL) ? Yn() : R();
        }
        function zn() {
          _n(), m(e.eq), ei(), R();
        }
        ...
        function ni() {
          ...
          switch (r.type) {
            ...
            case e.name: {
              ...
              let s = !1;
              return n === u._global ? (n1(), (s = !0)) : (s = bn(n, !0)), te(t), s;
            }
            default:
              return !1;
          }
        ...
        function bn(t, n) {
          switch (t) {
            case u._abstract:
              if ($t(n) && o(e._class))
                return (r.tokens[r.tokens.length - 1].type = e._abstract), Bt(!0, !1), !0;
              break;
            case u._enum:
              if ($t(n) && o(e.name))
        ...
        function si() {
          const t = r.snapshot();
          return (
            wn(), Gt(), Vo(), m(e.arrow), r.error ? (r.restoreFromSnapshot(t), !1) : (sn(!0), !0)
          );
        }
        function Jn() {
        ...
        function Vt() {
          ...
          t
            ...
            : (te(t), qt(), m(e.greaterThan), (r.tokens[r.tokens.length - 1].isType = !0));
        }
        function s1() {
          if (o(e.name))
        ...
        function ii(t, n, s) {
          ...
          if (o(e.lessThan) || o(e.bitShiftL)) {
            ...
            if (
              (Jn(),
              !n && x(e.parenL)
                ? ((r.tokens[r.tokens.length - 1].subscriptStartIndex = t), At())
                : o(e.backQuote)
                ? rr()
                : (r.type === e.greaterThan ||
                    (r.type !== e.parenL && r.type & e.IS_EXPRESSION_START && !qe())) &&
                  v(),
              r.error)
            )
        ...
        function ai() {
          if (x(e._import)) return P(u._type) && i() !== e.eq && Ae(u._type), zn(), !0;
        ...
        function fi() {
          if (r.type === e._const) {
            ...
            if (t.type === e.name && t.contextualKeyword === u._enum)
              return (
                m(e._const), Ae(u._enum), (r.tokens[r.tokens.length - 1].type = e._enum), Gn(), !0
              );
          }
          return !1;
        }
        ...
        function di(t) {
          if ((t && (o(e.lessThan) || o(e.bitShiftL)) && Jn(), Ce(u._implements))) {
        ...
        function wi(t, n) {
          ...
          return (r.type = e.typeParameterStart), wn(), (c = ht(t, n)), c || v(), c;
        }
        function Ii(t, n) {
          if (!o(e.lessThan)) return ht(t, n);
          const s = r.snapshot();
        ...
        function bi() {
          if (o(e.colon)) {
            const t = r.snapshot();
            Kt(e.colon), Fe() && v(), o(e.arrow) || v(), r.error && r.restoreFromSnapshot(t);
          }
          return x(e.arrow);
        }
        function Ti() {
        ...
        function Ai() {
          ...
          for (;;) {
            ...
            s === h.lineFeed
              ? (t = !0)
              : s !== h.space && s !== h.carriageReturn && s !== h.tab && (n = !0),
              r.pos++;
          }
        }
        function Si(t) {
            ...
            for (Wt(); ; )
              switch (r.type) {
                ...
                case e.jsxEmptyText:
                  ...
                  break;
                case e.braceL:
                  _(), o(e.ellipsis) ? (Ni(), Wt(), (n += 2)) : (o(e.braceR) || (n++, Ye()), Wt());
                  break;
                default:
                  v();
                  return;
        ...
        function ht(t, n) {
          ...
          (o(e.parenL) || o(e.name) || o(e._yield)) && (r.potentialArrowAt = r.start);
          const s = Oi(t);
        ...
        function Tn(t, n, s) {
          if (E && (e._in & e.PRECEDENCE_MASK) > n && !qe() && (Ce(u._as) || Ce(u._satisfies))) {
            const f = Q(1);
            $e(), te(f), qt(), Tn(t, n, s);
            return;
          }
          ...
          if (c > 0 && (!s || !o(e._in)) && c > n) {
            const f = r.type;
            _(), f === e.nullishCoalescing && (r.tokens[r.tokens.length - 1].nullishStartIndex = t);
        ...
        function tn() {
          ...
          if (P(u._module) && y() === h.leftCurlyBrace && !Ke()) return Zi(), !1;
        ...
        function Kn(t, n, s) {
          if (!n && x(e.doubleColon)) er(), (s.stop = !0), Zn(t, n);
            ...
            if (((r.tokens[t].isOptionalChainStart = !0), n && i() === e.parenL)) {
              s.stop = !0;
              return;
            }
            _(),
          ...
          } else if (x(e.dot)) (r.tokens[r.tokens.length - 1].subscriptStartIndex = t), En();
          else if (x(e.bracketL))
            (r.tokens[r.tokens.length - 1].subscriptStartIndex = t), Ye(), m(e.bracketR);
            ...
            if (h1()) {
              ...
              (r.tokens[r.tokens.length - 1].contextId = k),
                At(),
                (r.tokens[r.tokens.length - 1].contextId = k),
                qi() && (r.restoreFromSnapshot(c), (s.stop = !0), r.scopeDepth++, Gt(), Ui(f));
            } else {
              _(), (r.tokens[r.tokens.length - 1].subscriptStartIndex = t);
              const c = q();
        ...
        function h1() {
          return r.tokens[r.tokens.length - 1].contextualKeyword === u._async && !Fe();
        }
        function At() {
          let t = !0;
        ...
        function xt() {
          ...
          if (o(e.lessThan) && T) return (r.type = e.jsxTagStart), c1(), _(), !1;
          ...
          switch (r.type) {
            ...
            case e._import:
              return (
                _(), o(e.dot) && ((r.tokens[r.tokens.length - 1].type = e.name), _(), xe()), !1
              );
            case e.name: {
              const n = r.tokens.length,
                s = r.start,
              ...
              return (
                ...
                c === u._await
                  ...
                  : ((r.tokens[r.tokens.length - 1].identifierRole = N.Access), !1)
              );
            }
            case e._do:
              return _(), St(), !1;
        ...
        function rr() {
          for (me(), me(); !o(e.backQuote) && !r.error; ) m(e.dollarBraceL), Ye(), me(), me();
          _();
        }
        function sr(t, n) {
          const s = q();
          let c = !0;
          for (_(), r.tokens[r.tokens.length - 1].contextId = s; !x(e.braceR) && !r.error; ) {
            if (c) c = !1;
            else if ((m(e.comma), x(e.braceR))) break;
            let f = !1;
            if (o(e.ellipsis)) {
              const k = r.tokens.length;
              if ((Vs(), t && (r.tokens.length === k + 2 && jn(n), x(e.braceR)))) break;
              continue;
            }
            t || (f = x(e.star)),
              !t && P(u._async)
        ...
        function Gi(t) {
          return (
            !t &&
            (o(e.string) || o(e.num) || o(e.bracketL) || o(e.name) || !!(r.type & e.IS_KEYWORD))
          );
        }
        function Yi(t, n) {
          const s = r.start;
          return o(e.parenL) ? (t && v(), or(s, !1), !0) : Gi(t) ? (nn(n), or(s, !1), !0) : !1;
        }
        function Xi(t, n) {
          if (x(e.colon)) {
            t ? xn(n) : Xe(!1);
          ...
          j && dr(),
            x(e.bracketL)
              ? ((r.tokens[r.tokens.length - 1].contextId = t),
                ...
                m(e.bracketR),
                (r.tokens[r.tokens.length - 1].contextId = t))
              : (o(e.num) || o(e.string) || o(e.bigint) || o(e.decimal) ? xt() : En(),
        ...
        function k1(t) {
          (t && o(e.comma)) || (o(e.ellipsis) ? (Vs(), nr()) : o(e.question) ? _() : Xe(!1, !0));
        }
        function xe() {
          _(), (r.tokens[r.tokens.length - 1].type = e.name);
        }
        ...
        function Ki(t) {
          return (
            (t.type === e.name || !!(t.type & e.IS_KEYWORD)) && t.contextualKeyword !== u._from
          );
        }
        function pt(t) {
          const n = Q(0);
        ...
        function ta() {
          _(), xe(), o(e.lessThan) && ft(), m(e.parenL), mr(), m(e.parenR), ir(), R();
        }
        function ar() {
          o(e._class)
            ? ea()
        ...
        function ra() {
          for (o(e.string) ? xt() : xe(), m(e.braceL); !o(e.braceR) && !r.error; )
            o(e._import) ? (_(), F1()) : v();
          m(e.braceR);
        }
        function sa() {
          m(e._export),
            x(e._default)
              ...
              ? ar()
              : o(e.star) || o(e.braceL) || P(u._interface) || P(u._type) || P(u._opaque)
              ? L1()
              : v();
        }
        function oa() {
        ...
        function fr(t) {
          Ae(u._type), vn(), o(e.lessThan) && ft(), o(e.colon) && pt(e.colon), t || pt(e.eq), R();
        }
        function la() {
          dr(), b1(), x(e.eq) && rt();
        }
        ...
        function Ft() {
          const t = Q(0);
          for (m(e.lessThan); !o(e.greaterThan) && !r.error; ) rt(), o(e.greaterThan) || m(e.comma);
          m(e.greaterThan), te(t);
        }
        function ua() {
        ...
        function pr() {
          for (o(e.lessThan) && ft(), m(e.parenL); !o(e.parenR) && !o(e.ellipsis) && !r.error; )
        ...
        function ma() {
          if (o(e.ellipsis)) {
            ...
            rt();
          } else hr(), o(e.lessThan) || o(e.parenL) ? pr() : (x(e.question), pt());
        }
        function da() {
        ...
        function _a() {
          for (m(e.bracketL); r.pos < w.length && !o(e.bracketR) && (rt(), !o(e.bracketR)); )
            m(e.comma);
          m(e.bracketR);
        }
        function Nn() {
          const t = i();
          t === e.colon || t === e.question ? (xe(), x(e.question), pt()) : rt();
        }
        function mr() {
          for (; !o(e.parenR) && !o(e.ellipsis) && !r.error; ) Nn(), o(e.parenR) || m(e.comma);
          x(e.ellipsis) && Nn();
        }
        function y1() {
          let t = !1;
            ...
            case e.parenL:
              ...
              if (t)
                if (
                  ...
                  r.noAnonFunctionType || !(o(e.comma) || (o(e.parenR) && i() === e.arrow)))
                ) {
                  m(e.parenR);
                  return;
                } else x(e.comma);
        ...
        function ya() {
          for (y1(); !Fe() && (o(e.bracketL) || o(e.questionDot)); )
            x(e.questionDot), m(e.bracketL), x(e.bracketR) || (rt(), m(e.bracketR));
        }
        function x1() {
          x(e.question) ? x1() : ya();
        }
        ...
        function dr() {
          (o(e.plus) || o(e.minus)) && (_(), (r.tokens[r.tokens.length - 1].isType = !0));
        }
        function wa(t) {
          o(e.colon) && ir(), sn(!1, t);
        }
        ...
        function Aa(t) {
          if (t === u._declare) {
            if (o(e._class) || o(e.name) || o(e._function) || o(e._var) || o(e._export)) {
              const n = Q(1);
              ar(), te(n);
            }
          } else if (o(e.name)) {
        ...
        function Oa() {
          ...
          t ? _() : xe(),
            P(u._as) && !Se(u._as)
              ...
              : (t && (o(e.name) || r.type & e.IS_KEYWORD) && xe(), Ce(u._as) && xe());
        }
        function Ma() {
          if (o(e.lessThan)) {
            const t = Q(0);
        ...
        function qa(t, n) {
          if (o(e.lessThan)) {
            const s = r.snapshot();
            let c = ht(t, n);
            if (r.error) r.restoreFromSnapshot(s), (r.type = e.typeParameterStart);
            else return c;
            const f = Q(0);
        ...
        function $a(t, n = !1) {
          if (r.tokens[r.tokens.length - 1].contextualKeyword === u._async && o(e.lessThan)) {
            const s = r.snapshot();
        ...
        function T1() {
          Ae(u._enum), (r.tokens[r.tokens.length - 1].type = e._enum), xe(), Wa();
        }
        function Wa() {
          Ce(u._of) && _(), m(e.braceL), Ha(), m(e.braceR);
        }
        function Ha() {
          for (; !o(e.braceR) && !r.error && !x(e.ellipsis); ) Ga(), o(e.braceR) || m(e.comma);
        }
        function Ga() {
          xe(), x(e.eq) && _();
        }
        function Ya() {
          if ((Pn(e.eof), r.scopes.push(new O(0, r.tokens.length, !0)), r.scopeDepth !== 0))
        ...
        function Xa(t) {
          ...
          switch (n) {
            ...
            case e.name:
              ...
              } else if (r.contextualKeyword === u._using && !Ke() && i() === e.name) {
                Rn(!0);
                return;
              } else if (E1()) {
                Ae(u._await), Rn(!0);
        ...
        function tc() {
          ...
          if (n || o(e._var) || o(e._let) || o(e._const) || ec()) {
            if ((n && Ae(u._await), _(), C1(!0, r.type !== e._var), o(e._in) || P(u._of))) {
              v1(t);
              return;
            }
            gr();
        ...
        function cc() {
          if ((_(), St(), o(e._catch))) {
            ...
            if (
              (o(e.parenL) &&
                (r.scopeDepth++, (t = r.tokens.length), m(e.parenL), ac(), m(e.parenR)),
              St(),
              t != null)
            ) {
              const n = r.tokens.length;
        ...
        function gr() {
          m(e.semi), o(e.semi) || Ye(), m(e.semi), o(e.parenR) || Ye(), m(e.parenR), it(!1);
        }
        function v1(t) {
        ...
        function dc(t, n) {
          E && $n([u._declare, u._public, u._protected, u._private, u._override]);
          let s = !1;
          if (o(e.name) && r.contextualKeyword === u._static) {
            ...
            if (((r.tokens[r.tokens.length - 1].type = e._static), (s = !0), o(e.braceL))) {
          ...
          f.contextualKeyword === u._constructor && (c = !0),
            ...
            R1()
              ...
              ? ((r.tokens[r.tokens.length - 1].type = e._async),
                ...
                P1(),
                on(t, !1))
              : (f.contextualKeyword === u._get || f.contextualKeyword === u._set) &&
                !(K() && o(e.star))
        ...
        function L1() {
          ...
          (E && ai()) ||
            (Ic()
              ...
              : wc()
              ? (xe(),
                o(e.comma) && i() === e.star ? (m(e.comma), m(e.star), Ae(u._as), xe()) : D1(),
                cn())
              : x(e._default)
              ? yc()
              : Ec()
        ...
        function Ac() {
          ...
          xe(), (r.tokens[r.tokens.length - 1].identifierRole = N.ExportAccess), Ce(u._as) && xe();
        }
        function Sc() {
          const t = r.snapshot();
          return (
        ...
        function Rc() {
          ...
          _n(),
            P(u._as) &&
              ((r.tokens[r.tokens.length - 1].identifierRole = N.ImportAccess), _(), _n());
        }
        function M1() {
        ...
        function Dc(t, n, s, c) {
          if (c && s) throw new Error('Cannot combine flow and typescript plugins.');
          ve(t, n, s, c);
          const f = Pc();
        ...
        class ln {
          ...
          matchesContextualAtIndex(n, s) {
            return this.matches1AtIndex(n, e.name) && this.tokens[n].contextualKeyword === s;
          }
          ...
          matches2(n, s) {
            return (
              this.tokens[this.tokenIndex].type === n && this.tokens[this.tokenIndex + 1].type === s
            );
          }
          matches3(n, s, c) {
            return (
          ...
          appendTokenPrefix() {
            ...
            if (
              ...
              n.isOptionalChainStart &&
                ...
                this.tokenIndex > 0 && this.tokenAtRelativeIndex(-1).type === e._delete
                  ? n.isAsyncOperation
          ...
          appendTokenSuffix() {
            const n = this.currentToken();
            if (
              (n.isOptionalChainEnd && !this.disableESTransforms && (this.resultCode += '])'),
              n.numNullishCoalesceEnds && !this.disableESTransforms)
            )
              for (let s = 0; s < n.numNullishCoalesceEnds; s++) this.resultCode += '))';
          }
          appendCode(n) {
            this.resultCode += n;
          }
        ...
        function Oc(t, n, s, c) {
          ...
          for (n.nextToken(); !n.matchesContextIdAndLabel(e.braceR, ne); )
            if (n.matchesContextual(u._constructor) && !n.currentToken().isType)
              ({ constructorInitializerStatements: A, constructorInsertPos: fe } = B1(n));
            else if (n.matches1(e.semi))
              c || ge.push({ start: n.currentIndex(), end: n.currentIndex() + 1 }), n.nextToken();
              ...
              for (; Dn(n.currentToken()); )
                n.matches1(e._static) && (De = !0),
                  ...
                  (n.matches1(e._declare) || n.matches1(e._abstract)) && (He = !0),
                  n.nextToken();
              ...
              if (n.matches1(e.eq)) {
                ...
                if (lt == null) throw new Error('Expected rhsEndIndex on class field assignment.');
              ...
              } else (!c || He) && ge.push({ start: we, end: n.currentIndex() });
            }
          return (
        ...
        function Mc(t) {
          ...
          if (c == null) throw new Error('Expected isExpression on class token.');
          let f = null,
            k = !1;
          for (
            ...
            t.matches1(e._extends) && !t.currentToken().isType && (k = !0), t.nextToken();
        ...
        function B1(t) {
          ...
          for (; !t.matchesContextIdAndLabel(e.braceR, s); ) {
            if (!f && t.matches2(e._super, e.parenL)) {
              ...
              if (k == null) throw new Error('Expected a context ID on the super call');
              for (; !t.matchesContextIdAndLabel(e.parenR, k); ) t.nextToken();
              (c = t.currentIndex()), (f = !0);
            }
            t.nextToken();
          }
          return t.nextToken(), { constructorInitializerStatements: n, constructorInsertPos: c };
        }
        function Dn(t) {
          return [
            e._async,
        ...
        const q1 = { typeDeclarations: new Set(), valueDeclarations: new Set() };
        function U1(t) {
          const n = new Set(),
            s = new Set();
          for (let c = 0; c < t.tokens.length; c++) {
            ...
            f.type === e.name &&
              S(f) &&
              (f.isType ? n.add(t.identifierNameForToken(f)) : s.add(t.identifierNameForToken(f)));
          }
        ...
        function $1(t) {
          ...
          return t.matchesContextualAtIndex(n + 1, u._from) && t.matches1AtIndex(n + 2, e.string);
        }
        function jt(t) {
          (t.matches2(e._with, e.braceL) ||
            (t.matches2(e.name, e.braceL) && t.matchesContextual(u._assert))) &&
            (t.removeToken(), t.removeToken(), t.removeBalancedCode(), t.removeToken());
        }
        function V1(t, n, s, c) {
          if (!t || n) return !1;
          ...
          if (k !== 3 && !(k === 4 && s.matches1AtIndex(f.rhsEndIndex - 1, e.semi))) return !1;
        ...
        class un extends ut {
          ...
          getPrefixCode() {
            ...
            return (
              this.hadExport &&
                (n += 'Object.defineProperty(exports, "__esModule", {value: true});'),
              n
            );
          }
          getSuffixCode() {
...
`
          ...
          process() {
            return this.tokens.matches3(e._import, e.name, e.eq)
              ...
              : this.tokens.matches1(e._export) && !this.tokens.currentToken().isType
              ? ((this.hadExport = !0), this.processExport())
              : this.tokens.matches2(e.name, e.postIncDec) && this.processPostIncDec()
              ? !0
          ...
          processImport() {
            if (this.tokens.matches2(e._import, e.parenL)) {
              ...
              if (c == null) throw new Error('Expected context ID on dynamic import invocation.');
              for (this.tokens.copyToken(); !this.tokens.matchesContextIdAndLabel(e.parenR, c); )
            ...
            jt(this.tokens), this.tokens.matches1(e.semi) && this.tokens.removeToken();
          }
          removeImportAndDetectIfShouldElide() {
            if (
              (this.tokens.removeInitialToken(),
              this.tokens.matchesContextual(u._type) &&
                !this.tokens.matches1AtIndex(this.tokens.currentIndex() + 1, e.comma) &&
                !this.tokens.matchesContextualAtIndex(this.tokens.currentIndex() + 1, u._from))
            )
            ...
            for (; !this.tokens.matches1(e.string); )
              ((!n && this.tokens.matches1(e.braceL)) || this.tokens.matches1(e.comma)) &&
                (this.tokens.removeToken(),
          ...
          processIdentifier() {
            ...
            if (n.identifierRole === N.ObjectShorthand) return this.processObjectShorthand();
            ...
            for (; c < this.tokens.tokens.length && this.tokens.tokens[c].type === e.parenR; ) c++;
            return (
          ...
          processExport() {
            ...
            if (this.tokens.matches2(e._export, e.braceL)) return this.processExportBindings(), !0;
            if (
              this.tokens.matches2(e._export, e.name) &&
              this.tokens.matchesContextualAtIndex(this.tokens.currentIndex() + 1, u._type)
            ) {
              if (
                (this.tokens.removeInitialToken(),
                this.tokens.removeToken(),
                ...
                for (; !this.tokens.matches1(e.braceR); ) this.tokens.removeToken();
                this.tokens.removeToken();
              } else
                this.tokens.removeToken(),
              ...
              return (
                this.tokens.matchesContextual(u._from) &&
                  this.tokens.matches1AtIndex(this.tokens.currentIndex() + 1, e.string) &&
                  (this.tokens.removeToken(), this.tokens.removeToken(), jt(this.tokens)),
                !0
              );
            }
            if (
            ...
            if (this.tokens.matches2(e._export, e.star)) return this.processExportStar(), !0;
          ...
          processAssignment() {
            ...
            if (
              ...
              (n >= 2 && [e._var, e._let, e._const].includes(this.tokens.tokens[n - 2].type))
            )
              return !1;
            const c = this.importProcessor.resolveExportBinding(
              this.tokens.identifierNameForToken(s),
            );
            return c ? (this.tokens.copyToken(), this.tokens.appendCode(` ${c} =`), !0) : !1;
          }
          ...
          processPreIncDec() {
            ...
            return f ? (this.tokens.appendCode(`${f} = `), this.tokens.copyToken(), !0) : !1;
          }
          processPostIncDec() {
            const n = this.tokens.currentIndex(),
            ...
            if (A === '++') this.tokens.replaceToken(`(${B} = ${k} = ${B} + 1, ${B} - 1)`);
            else if (A === '--') this.tokens.replaceToken(`(${B} = ${k} = ${B} - 1, ${B} + 1)`);
          ...
          processExportDefault() {
            let n = !0;
            if (
              this.tokens.matches4(e._export, e._default, e._function, e.name) ||
              (this.tokens.matches5(e._export, e._default, e.name, e._function, e.name) &&
                this.tokens.matchesContextualAtIndex(this.tokens.currentIndex() + 2, u._async))
            ) {
              ...
              this.tokens.matches5(e._export, e._default, e._abstract, e._class, e.name) ||
          ...
          copyDecorators() {
            for (; this.tokens.matches1(e.at); )
              if ((this.tokens.copyToken(), this.tokens.matches1(e.parenL)))
                ...
                for (this.tokens.copyExpectedToken(e.name); this.tokens.matches1(e.dot); )
                  this.tokens.copyExpectedToken(e.dot), this.tokens.copyExpectedToken(e.name);
          ...
          processSimpleExportVar() {
            ...
            const n = this.tokens.identifierName();
            for (; !this.tokens.matches1(e.eq); ) this.rootTransformer.processToken();
          ...
          processComplexExportVar() {
            ...
            for (;;)
              ...
              else if (this.tokens.matches1(e.braceR) || this.tokens.matches1(e.bracketR))
                s--, this.tokens.copyToken();
              else {
                if (s === 0 && !this.tokens.matches1(e.name) && !this.tokens.currentToken().isType)
                  break;
                if (this.tokens.matches1(e.eq)) {
                  const c = this.tokens.currentToken().rhsEndIndex;
                  if (c == null) throw new Error('Expected = token with an end index.');
                  for (; this.tokens.currentIndex() < c; ) this.rootTransformer.processToken();
                } else {
                  ...
                  if (Ne(c)) {
                    ...
                    if (k === null)
                      throw new Error(`Expected a replacement for ${f} in \`export var\` syntax.`);
          ...
          processExportBindings() {
            ...
            for (;;) {
              ...
              for (; this.tokens.currentIndex() < c.endIndex; ) this.tokens.removeToken();
              if (!(c.isType || (!n && this.shouldElideExportedIdentifier(c.leftName)))) {
                const k = c.rightName;
                k === 'default' ? (this.hadDefaultExport = !0) : (this.hadNamedExport = !0);
                const A = c.leftName,
              ...
              if (this.tokens.matches2(e.comma, e.braceR)) {
                this.tokens.removeToken(), this.tokens.removeToken();
                break;
              } else if (this.tokens.matches1(e.comma)) this.tokens.removeToken();
              else
          ...
          processExportStar() {
            for (this.tokens.removeInitialToken(); !this.tokens.matches1(e.string); )
              this.tokens.removeToken();
            const n = this.tokens.stringValue();
            this.tokens.replaceTokenTrimmingLeftWhitespace(this.importProcessor.claimImportCode(n)),
              jt(this.tokens),
              this.tokens.matches1(e.semi) && this.tokens.removeToken();
          }
        ...
        class jc extends ut {
          constructor(n, s, c, f, k, A, B, ee) {
            super(),
              ...
              (this.injectCreateRequireForImportRequire = !!ee.injectCreateRequireForImportRequire);
          }
          process() {
            if (this.tokens.matches3(e._import, e.name, e.eq)) return this.processImportEquals();
            if (
            ...
            if (
              this.tokens.matches5(e._export, e._import, e.name, e.name, e.eq) &&
              this.tokens.matchesContextualAtIndex(this.tokens.currentIndex() + 2, u._type)
            ) {
              this.tokens.removeInitialToken();
            ...
            if (this.tokens.matches2(e._export, e._default)) return this.processExportDefault();
            if (this.tokens.matches2(e._export, e.braceL)) return this.processNamedExports();
            if (
              this.tokens.matches2(e._export, e.name) &&
              this.tokens.matchesContextualAtIndex(this.tokens.currentIndex() + 1, u._type)
            ) {
          ...
          processImport() {
            ...
            if (this.removeImportTypeBindings()) {
              for (this.tokens.restoreToSnapshot(n); !this.tokens.matches1(e.string); )
                this.tokens.removeToken();
              this.tokens.removeToken(),
                jt(this.tokens),
                this.tokens.matches1(e.semi) && this.tokens.removeToken();
          ...
          removeImportTypeBindings() {
            if (
              ...
              return !0;
            if (this.tokens.matches1(e.string)) return this.tokens.copyToken(), !1;
            this.tokens.matchesContextual(u._module) &&
              this.tokens.matchesContextualAtIndex(this.tokens.currentIndex() + 2, u._from) &&
              this.tokens.copyToken();
            let n = !1,
              s = !1,
              c = !1;
            if (
              (this.tokens.matches1(e.name) &&
                (this.shouldAutomaticallyElideImportedName(this.tokens.identifierName())
                  ...
                  : ((n = !0),
                    this.tokens.copyToken(),
                    this.tokens.matches1(e.comma) && ((c = !0), this.tokens.removeToken()))),
              this.tokens.matches1(e.star))
            )
              this.shouldAutomaticallyElideImportedName(
                this.tokens.identifierNameAtRelativeIndex(2),
              )
                ? (this.tokens.removeToken(), this.tokens.removeToken(), this.tokens.removeToken())
              ...
              for (
                ...
                if (f.isType || this.shouldAutomaticallyElideImportedName(f.rightName)) {
                  for (; this.tokens.currentIndex() < f.endIndex; ) this.tokens.removeToken();
                  this.tokens.matches1(e.comma) && this.tokens.removeToken();
                } else {
                  for (n = !0; this.tokens.currentIndex() < f.endIndex; ) this.tokens.copyToken();
          ...
          processNamedExports() {
            ...
            this.tokens.copyExpectedToken(e._export), this.tokens.copyExpectedToken(e.braceL);
            const n = $1(this.tokens);
            let s = !1;
            for (; !this.tokens.matches1(e.braceR); ) {
              const c = Jt(this.tokens);
              if (c.isType || (!n && this.shouldElideExportedName(c.leftName))) {
                for (; this.tokens.currentIndex() < c.endIndex; ) this.tokens.removeToken();
                this.tokens.matches1(e.comma) && this.tokens.removeToken();
              } else {
                for (s = !0; this.tokens.currentIndex() < c.endIndex; ) this.tokens.copyToken();
                this.tokens.matches1(e.comma) && this.tokens.copyToken();
              }
            }
            return (
        ...
        class qc extends ut {
          ...
          processEnum() {
            this.tokens.replaceToken('const'), this.tokens.copyExpectedToken(e.name);
            let n = !1;
            ...
            const c = !n && !s;
            for (
              this.tokens.replaceTokenTrimmingLeftWhitespace(c ? '.Mirrored([' : '({');
              !this.tokens.matches1(e.braceR);
          ...
          processEnumElement(n, s) {
            if (n) {
              const c = this.tokens.identifierName();
              this.tokens.copyToken(), this.tokens.appendCode(`: Symbol("${c}")`);
            } else
              s
                ? (this.tokens.copyToken(),
                  this.tokens.replaceTokenTrimmingLeftWhitespace(':'),
        ...
        function Uc(t) {
          ...
          for (; c < t.length; ) {
            const f = t[c],
              k = t[c + 1];
            if (((c += 2), (f === 'optionalAccess' || f === 'optionalCall') && s == null)) return;
          ...
          extractHoistedCalls() {
            ...
            for (; this.tokens.matches3(e.dot, e.name, e.parenL); ) {
              ...
              if ($c.includes(s)) {
                ...
                n ? this.tokens.copyToken() : this.tokens.replaceToken(`${Fn}.`),
                  this.tokens.copyToken(),
                  this.tokens.copyToken(),
                  this.rootTransformer.processBalancedCode(),
                  this.tokens.copyExpectedToken(e.parenR),
            ...
            if (
              ...
              if (
                ...
                this.justSkippedSuper() && this.tokens.appendCode('.bind(this)'),
                  this.tokens.replaceTokenTrimmingLeftWhitespace(`, 'optionalCall', ${f}`);
              else if (this.tokens.matches2(e.questionDot, e.bracketL))
                this.tokens.replaceTokenTrimmingLeftWhitespace(`, 'optionalAccess', ${f}`);
              else if (this.tokens.matches1(e.questionDot))
                this.tokens.replaceTokenTrimmingLeftWhitespace(`, 'optionalAccess', ${f}.`);
              else if (this.tokens.matches1(e.dot))
                this.tokens.replaceTokenTrimmingLeftWhitespace(`, 'access', ${f}.`);
              else if (this.tokens.matches1(e.bracketL))
                this.tokens.replaceTokenTrimmingLeftWhitespace(`, 'access', ${f}[`);
              else if (this.tokens.matches1(e.parenL))
                this.justSkippedSuper() && this.tokens.appendCode('.bind(this)'),
                  this.tokens.replaceTokenTrimmingLeftWhitespace(`, 'call', ${f}(`);
          ...
          isLastSubscriptInChain() {
            ...
            for (let s = this.tokens.currentIndex() + 1; ; s++) {
              ...
              if (
                ...
                return !0;
              if (n === 0 && this.tokens.tokens[s].subscriptStartIndex != null) return !1;
            }
          }
          justSkippedSuper() {
            let n = 0,
        ...
        class Gc extends ut {
          ...
          process() {
            ...
            if (this.tokens.identifierName() === 'createReactClass') {
              ...
              return (
                s ? this.tokens.replaceToken(`(0, ${s})`) : this.tokens.copyToken(),
            ...
            if (
              ...
              const s =
                (this.importProcessor && this.importProcessor.getIdentifierReplacement('React')) ||
                'React';
              return (
                s
                  ? (this.tokens.replaceToken(s), this.tokens.copyToken(), this.tokens.copyToken())
                  : (this.tokens.copyToken(), this.tokens.copyToken(), this.tokens.copyToken()),
                this.tryProcessCreateClassCall(n),
                !0
              );
            }
          ...
          findDisplayName(n) {
            return n < 2
              ...
              : n >= 2 && this.tokens.tokens[n - 2].identifierRole === N.ObjectKey
              ? this.tokens.identifierNameAtIndex(n - 2)
          ...
          classNeedsDisplayName() {
            ...
            if (c == null) throw new Error('Expected non-null context ID on object open-brace.');
        ...
        class Ir extends ut {
          ...
          constructor(n, s) {
            super(), (this.tokens = n), (this.filePath = s), Ir.prototype.__init.call(this);
          }
      ...
      (function () {
        ...
        enterModule && enterModule(module);
          ...
          getSuffixCode() {
            ...
            const s = Array.from(n).map((c) => ({ variableName: c, uniqueLocalName: c }));
            return (
...
${s.map(
  ({ variableName: c, uniqueLocalName: f }) =>
    `  reactHotLoader.register(${c}, "${f}", ${JSON.stringify(this.filePath || '')});`,
).join(`
`)}
  leaveModule(module);
})();`
        ...
        class Xc extends ut {
          ...
          process() {
            return this.rootTransformer.processPossibleArrowParamEnd() ||
              ...
              : this.tokens.matches1(e._enum) || this.tokens.matches2(e._const, e._enum)
              ? (this.processEnum(), !0)
              : this.tokens.matches2(e._export, e._enum) ||
                this.tokens.matches3(e._export, e._const, e._enum)
          ...
          processEnum(n = !1) {
            ...
            const s = this.tokens.identifierName();
            this.tokens.removeToken(),
              n && !this.isImportsTransformEnabled && this.tokens.appendCode('export '),
          ...
          processEnumBody(n) {
            let s = null;
            for (; !this.tokens.matches1(e.braceR); ) {
              const { nameStringCode: c, variableName: f } = this.extractEnumKeyInfo(
          ...
          extractEnumKeyInfo(n) {
            if (n.type === e.name) {
              ...
              return { nameStringCode: `"${s}"`, variableName: W1(s) ? s : null };
          ...
          processExplicitValueEnumMember(n, s, c) {
            const f = this.tokens.currentToken().rhsEndIndex;
            if (f == null) throw new Error('Expected rhsEndIndex on enum assign.');
            if (c != null) {
              for (
              ...
              for (
                this.tokens.appendCode(`${n}[${n}[${s}]`), this.tokens.copyToken();
                this.tokens.currentIndex() < f;
          ...
          processImplicitValueEnumMember(n, s, c, f) {
            let k = f != null ? `${f} + 1` : '0';
            c != null && (this.tokens.appendCode(`const ${c} = ${k}; `), (k = c)),
        ...
        class On {
          ...
          constructor(n, s, c, f) {
            ...
            (this.tokens = k),
              ...
              (this.isReactHotLoaderTransformEnabled = s.includes('react-hot-loader')),
              ...
              s.includes('jsx') &&
                (f.jsxRuntime !== 'preserve' &&
                  this.transformers.push(new Pt(this, k, A, this.nameManager, f)),
            ...
            s.includes('flow') && this.transformers.push(new qc(this, k, s.includes('imports'))),
              s.includes('typescript') &&
                this.transformers.push(new Xc(this, k, s.includes('imports'))),
              s.includes('jest') && this.transformers.push(new wr(this, k, this.nameManager, A));
          }
          transform() {
...
`)),
            ...
            } else return { code: s + k + c, mappings: this.shiftMappings(f.mappings, s.length) };
          }
          processBalancedCode() {
            let n = 0,
              s = 0;
            for (; !this.tokens.isAtEnd(); ) {
              if (this.tokens.matches1(e.braceL) || this.tokens.matches1(e.dollarBraceL)) n++;
          ...
          processClass() {
            const n = Oc(this, this.tokens, this.nameManager, this.disableESTransforms),
              s =
                (n.headerInfo.isExpression || !n.headerInfo.className) &&
                n.staticInitializerNames.length + n.instanceInitializerNames.length > 0;
            ...
            if (k == null) throw new Error('Expected class to have a context ID.');
            for (
            ...
            s
              ? this.tokens.appendCode(`, ${A.map((B) => `${B}, `).join('')}${c})`)
          ...
          processClassBody(n, s) {
            ...
            if (ge == null) throw new Error('Expected non-null context ID on class.');
            this.tokens.copyExpectedToken(e.braceL),
            ...
            if (f === null && ne) {
              ...
              if (c.hasSuperclass) {
                ...
                this.tokens.appendCode(`constructor(...${De}) { super(...${De}); ${we}; }`);
            ...
            for (; !this.tokens.matchesContextIdAndLabel(e.braceR, ge); )
              if (fe < A.length && this.tokens.currentIndex() === A[fe].start) {
                ...
                for (
                  this.tokens.matches1(e.bracketL)
                    ? this.tokens.copyTokenWithPrefix(`${A[fe].initializerName}() {this`)
                    : this.tokens.matches1(e.string) || this.tokens.matches1(e.num)
                    ? (this.tokens.copyTokenWithPrefix(`${A[fe].initializerName}() {this[`),
                      (we = !0))
                    : this.tokens.copyTokenWithPrefix(`${A[fe].initializerName}() {this.`);
              ...
              } else if (be < ee.length && this.tokens.currentIndex() >= ee[be].start) {
                for (
                  this.tokens.currentIndex() < ee[be].end && this.tokens.removeInitialToken();
                ...
                this.tokens.currentIndex() === f
                  ? (this.tokens.copyToken(),
                    ne && this.tokens.appendCode(`;${this.makeConstructorInitCode(k, B, s)};`),
                    this.processToken())
                  : this.processToken();
            this.tokens.copyExpectedToken(e.braceR);
          }
          makeConstructorInitCode(n, s, c) {
            return [...n, ...s.map((f) => `${c}.prototype.${f}.call(this)`)].join(';');
          }
          ...
          processPossibleAsyncArrowWithTypeParams() {
            if (!this.tokens.matchesContextual(u._async) && !this.tokens.matches1(e._async))
              return !1;
            ...
            if (this.tokens.matches1AtIndex(s, e.parenL)) {
              for (
                this.tokens.replaceToken('async ('), this.tokens.removeInitialToken();
        ...
        function Tl(t, n) {
          ...
          const s = Object.keys(n[0]).filter(
              (ne) =>
                ne !== 'type' && ne !== 'value' && ne !== 'start' && ne !== 'end' && ne !== 'loc',
            ),
            c = Object.keys(n[0].type).filter((ne) => ne !== 'label' && ne !== 'keyword'),
            f = ['Location', 'Label', 'Raw', ...s, ...c],
            k = new LinesAndColumns(t),
            A = [f, ...n.map(ee)],
            B = f.map(() => 0);
          for (const ne of A)
            for (let we = 0; we < ne.length; we++) B[we] = Math.max(B[we], ne[we].length);
          return A.map((ne) => ne.map((we, De) => we.padEnd(B[De])).join(' ')).join(`
`);
          function ee(ne) {
          ...
          n++,
            !t.matches1AtIndex(n, e.parenL) &&
              (t.matches1AtIndex(n, e.name) &&
                (s.add(t.identifierNameAtIndex(n)), n++, t.matches1AtIndex(n, e.comma) && n++),
              t.matches1AtIndex(n, e.star) && ((n += 2), s.add(t.identifierNameAtIndex(n)), n++),
        ...
        function Zc(t, n, s) {
          for (;;) {
            ...
            else throw new Error(`Unexpected token: ${JSON.stringify(t.tokens[n])}`);
          }
        }
        function El() {
          return '3.35.0';
        ...
        function Kc(t, n) {
          ...
          try {
            const s = H1(t, n),
              f = new On(s, n.transforms, !!n.enableLegacyBabel5ModuleInterop, n).transform();
            let k = { code: f.code };
            if (n.sourceMapOptions) {
              if (!n.filePath)
                throw new Error('filePath must be specified when generating a source map.');
              k = Q1(J1({}, k), {
                sourceMap: ro(f, n.filePath, n.sourceMapOptions, t, s.tokenProcessor.tokens),
              });
            }
            return k;
          } catch (s) {
        ...
        function H1(t, n) {
          ...
          return (
            n.transforms.includes('imports')
              ...
              : n.transforms.includes('typescript') && !n.keepUnusedImports && Us(ge, ee, Jc(ge)),
            {
              tokenProcessor: ge,
              scopes: ee,
              nameManager: fe,
        ...
        function Tr() {
          ...
          function vt(Z, F, V) {
            ...
            return function (Te, _e) {
              if (ke === 'executing') throw new Error('Generator is already running');
              if (ke === 'completed') {
              ...
              for (V.method = Te, V.arg = _e; ; ) {
                ...
                if (V.method === 'next') V.sent = V._sent = V.arg;
                  ...
                  if (ke === 'suspendedStart') throw ((ke = 'completed'), V.arg);
                  V.dispatchException(V.arg);
                } else V.method === 'return' && V.abrupt('return', V.arg);
                ke = 'executing';
                var We = be(Z, F, V);
                if (We.type === 'normal') {
                  if (((ke = V.done ? 'completed' : 'suspendedYield'), We.arg === ge)) continue;
                  return { value: We.arg, done: V.done };
                }
                We.type === 'throw' && ((ke = 'completed'), (V.method = 'throw'), (V.arg = We.arg));
              }
            };
          }
          function wt(Z, F) {
            ...
            if (ke === void 0)
              return (
                ...
                (V === 'throw' &&
                  Z.iterator.return &&
                  ((F.method = 'return'), (F.arg = void 0), wt(Z, F), F.method === 'throw')) ||
                  (V !== 'return' &&
                    ((F.method = 'throw'),
                    (F.arg = new TypeError("The iterator does not provide a '" + V + "' method")))),
                ge
              );
            var Te = be(ke, Z.iterator, F.arg);
            if (Te.type === 'throw')
              return (F.method = 'throw'), (F.arg = Te.arg), (F.delegate = null), ge;
            var _e = Te.arg;
            return _e
              ? _e.done
                ? ((F[Z.resultName] = _e.value),
                  (F.next = Z.nextLoc),
                  F.method !== 'return' && ((F.method = 'next'), (F.arg = void 0)),
                  (F.delegate = null),
                  ge)
                : _e
              : ((F.method = 'throw'),
          ...
          function dt(Z) {
            (this.tryEntries = [{ tryLoc: 'root' }]), Z.forEach(Ct, this), this.reset(!0);
          }
          function kt(Z) {
            if (Z) {
              var F = Z[k];
              ...
              if (!isNaN(Z.length)) {
                var V = -1,
                  ke = function Te() {
                    for (; ++V < Z.length; )
                      if (s.call(Z, V)) return (Te.value = Z[V]), (Te.done = !1), Te;
          ...
          return (
            ...
            (t.isGeneratorFunction = function (Z) {
              ...
              return !!F && (F === we || (F.displayName || F.name) === 'GeneratorFunction');
            }),
            (t.mark = function (Z) {
              return (
            ...
            (dt.prototype = {
              ...
              abrupt: function (F, V) {
                ...
                return (
                  (Be.type = F),
                  (Be.arg = V),
                  _e ? ((this.method = 'next'), (this.next = _e.finallyLoc), ge) : this.complete(Be)
                );
              },
              ...
              finish: function (F) {
                for (var V = this.tryEntries.length - 1; V >= 0; --V) {
                  ...
                  if (ke.finallyLoc === F)
                    return this.complete(ke.completion, ke.afterLoc), mt(ke), ge;
                }
              },
              catch: function (F) {
                for (var V = this.tryEntries.length - 1; V >= 0; --V) {
              ...
              delegateYield: function (F, V, ke) {
                return (
                  (this.delegate = { iterator: kt(F), resultName: V, nextLoc: ke }),
                  ...
                  for (;;)
                    switch ((f.prev = f.next)) {
                      case 0:
                        return f.abrupt(
                          'return',
                          Kc(s, { transforms: ['typescript', 'jsx', 'imports'] }).code,
                        );
                      case 1:
                      case 'end':
                        return f.stop();
      ...
      79742: function (Le, I) {
        ...
        function C(w) {
          var ce = w.length;
          if (ce % 4 > 0) throw new Error('Invalid string. Length must be a multiple of 4');
          var q = w.indexOf('=');
          q === -1 && (q = ce);
          var oe = q === ce ? 0 : 4 - (q % 4);
          return [q, oe];
        ...
        function T(w) {
          ...
          return (
            ie === 2 &&
              ((ce = (u[w.charCodeAt(Se)] << 2) | (u[w.charCodeAt(Se + 1)] >> 4)),
              (ye[ve++] = ce & 255)),
            ie === 1 &&
              ((ce =
        ...
        function E(w) {
          return H[(w >> 18) & 63] + H[(w >> 12) & 63] + H[(w >> 6) & 63] + H[w & 63];
        }
        function j(w, ce, q) {
          for (var oe, ie = [], ye = ce; ye < q; ye += 3)
            (oe = ((w[ye] << 16) & 16711680) + ((w[ye + 1] << 8) & 65280) + (w[ye + 2] & 255)),
              ie.push(E(oe));
          return ie.join('');
        }
        function r(w) {
          for (
            var ce, q = w.length, oe = q % 3, ie = [], ye = 16383, ve = 0, P = q - oe;
            ve < P;
            ve += ye
          )
          ...
          return (
            oe === 1
              ? ((ce = w[q - 1]), ie.push(H[ce >> 2] + H[(ce << 4) & 63] + '=='))
              : oe === 2 &&
                ((ce = (w[q - 2] << 8) + w[q - 1]),
                ie.push(H[ce >> 10] + H[(ce >> 4) & 63] + H[(ce << 2) & 63] + '=')),
            ie.join('')
          );
        }
      },
      48764: function (Le, I, H) {
        ...
        function X() {
          try {
            ...
            return (
              ...
              o.foo() === 42 && typeof o.subarray == 'function' && o.subarray(1, 1).byteLength === 0
            );
          } catch (i) {
            return !1;
          }
        ...
        function d(o, i, a) {
          if (!d.TYPED_ARRAY_SUPPORT && !(this instanceof d)) return new d(o, i, a);
          if (typeof o == 'number') {
            if (typeof i == 'string')
        ...
        function E(o) {
          if (typeof o != 'number') throw new TypeError('"size" argument must be a number');
          if (o < 0) throw new RangeError('"size" argument must not be negative');
        }
        function j(o, i, a, l) {
          return (
            E(i),
        ...
        function w(o, i, a) {
          if (((typeof a != 'string' || a === '') && (a = 'utf8'), !d.isEncoding(a)))
        ...
        function q(o, i, a, l) {
          ...
          if (i.byteLength < a + (l || 0)) throw new RangeError("'length' is out of bounds");
          return (
            a === void 0 && l === void 0
              ? (i = new Uint8Array(i))
              : l === void 0
            ...
            d.TYPED_ARRAY_SUPPORT ? ((o = i), (o.__proto__ = d.prototype)) : (o = ce(o, i)),
            o
          );
        }
        function oe(o, i) {
          ...
          if (i) {
            if (
              (typeof ArrayBuffer != 'undefined' && i.buffer instanceof ArrayBuffer) ||
              'length' in i
            )
              return typeof i.length != 'number' || Oe(i.length) ? h(o, 0) : ce(o, i);
        ...
        (d.isBuffer = function (i) {
          ...
          (d.compare = function (i, a) {
            if (!d.isBuffer(i) || !d.isBuffer(a)) throw new TypeError('Arguments must be Buffers');
            if (i === a) return 0;
            for (var l = i.length, p = a.length, g = 0, y = Math.min(l, p); g < y; ++g)
              if (i[g] !== a[g]) {
                (l = i[g]), (p = a[g]);
                break;
              }
          ...
          (d.concat = function (i, a) {
            ...
            var l;
            if (a === void 0) for (a = 0, l = 0; l < i.length; ++l) a += i[l].length;
        ...
        (d.prototype.swap16 = function () {
          ...
          (d.prototype.swap32 = function () {
            ...
            for (var a = 0; a < i; a += 4) Se(this, a, a + 3), Se(this, a + 1, a + 2);
            return this;
          }),
        ...
        function Ce(o, i, a, l, p) {
          ...
          if (typeof i == 'number')
            return (
              (i = i & 255),
              d.TYPED_ARRAY_SUPPORT && typeof Uint8Array.prototype.indexOf == 'function'
                ? p
        ...
        (d.prototype.write = function (i, a, l, p) {
          ...
          else if (l === void 0 && typeof a == 'string') (p = a), (l = this.length), (a = 0);
          else if (isFinite(a))
            (a = a | 0),
              isFinite(l) ? ((l = l | 0), p === void 0 && (p = 'utf8')) : ((p = l), (l = void 0));
          else
            throw new Error(
        ...
        function v(o, i, a) {
          return i === 0 && a === o.length ? e.fromByteArray(o) : e.fromByteArray(o.slice(i, a));
        }
        function de(o, i, a) {
          ...
          for (var l = [], p = i; p < a; ) {
            ...
            if (p + Y <= a) {
              ...
              switch (Y) {
                ...
                case 2:
                  (W = o[p + 1]),
                    (W & 192) === 128 && ((le = ((g & 31) << 6) | (W & 63)), le > 127 && (y = le));
                  break;
                case 3:
                  (W = o[p + 1]),
                    (he = o[p + 2]),
                ...
                case 4:
                  (W = o[p + 1]),
                    ...
                    (W & 192) === 128 &&
                      (he & 192) === 128 &&
                      (Ee & 192) === 128 &&
                      ((le = ((g & 15) << 18) | ((W & 63) << 12) | ((he & 63) << 6) | (Ee & 63)),
            ...
            y === null
              ? ((y = 65533), (Y = 1))
              : y > 65535 &&
                ((y -= 65536), l.push(((y >>> 10) & 1023) | 55296), (y = 56320 | (y & 1023))),
              l.push(y),
              (p += Y);
          }
          return U(l);
        ...
        d.prototype.slice = function (i, a) {
          ...
          (i = ~~i),
            ...
            a < i && (a = i);
          var p;
          if (d.TYPED_ARRAY_SUPPORT) (p = this.subarray(i, a)), (p.__proto__ = d.prototype);
          else {
            var g = a - i;
            p = new d(g, void 0);
        ...
        function re(o, i, a) {
          ...
          if (o + i > a) throw new RangeError('Trying to access beyond buffer length');
        }
        (d.prototype.readUIntLE = function (i, a, l) {
          (i = i | 0), (a = a | 0), l || re(i, a, this.length);
          for (var p = this[i], g = 1, y = 0; ++y < a && (g *= 256); ) p += this[i + y] * g;
          return p;
        }),
          (d.prototype.readUIntBE = function (i, a, l) {
            (i = i | 0), (a = a | 0), l || re(i, a, this.length);
            for (var p = this[i + --a], g = 1; a > 0 && (g *= 256); ) p += this[i + --a] * g;
            return p;
          }),
          ...
          (d.prototype.readIntBE = function (i, a, l) {
            (i = i | 0), (a = a | 0), l || re(i, a, this.length);
            for (var p = a, g = 1, y = this[i + --p]; p > 0 && (g *= 256); ) y += this[i + --p] * g;
            return (g *= 128), y >= g && (y -= Math.pow(2, 8 * a)), y;
          }),
          (d.prototype.readInt8 = function (i, a) {
            return a || re(i, 1, this.length), this[i] & 128 ? (255 - this[i] + 1) * -1 : this[i];
          }),
        ...
        function N(o, i, a, l, p, g) {
          if (!d.isBuffer(o)) throw new TypeError('"buffer" argument must be a Buffer instance');
        ...
        (d.prototype.writeUIntLE = function (i, a, l, p) {
          ...
          var y = 1,
            Y = 0;
          for (this[a] = i & 255; ++Y < l && (y *= 256); ) this[a + Y] = (i / y) & 255;
          return a + l;
        }),
          (d.prototype.writeUIntBE = function (i, a, l, p) {
            ...
            var y = l - 1,
              Y = 1;
            for (this[a + y] = i & 255; --y >= 0 && (Y *= 256); ) this[a + y] = (i / Y) & 255;
            return a + l;
          }),
        ...
        function se(o, i, a, l) {
          ...
          for (var p = 0, g = Math.min(o.length - a, 2); p < g; ++p)
            o[a + p] = (i & (255 << (8 * (l ? p : 1 - p)))) >>> ((l ? p : 1 - p) * 8);
        }
        ...
        (d.prototype.writeDoubleLE = function (i, a, l) {
          ...
          (d.prototype.copy = function (i, a, l, p) {
            ...
            var g = p - l,
              y;
            if (this === i && l < a && a < p) for (y = g - 1; y >= 0; --y) i[y + a] = this[y + l];
        ...
        function Re(o) {
          for (var i = [], a = 0; a < o.length; ++a) i.push(o.charCodeAt(a) & 255);
          return i;
        }
        function Q(o, i) {
          for (var a, l, p, g = [], y = 0; y < o.length && !((i -= 2) < 0); ++y)
            (a = o.charCodeAt(y)), (l = a >> 8), (p = a % 256), g.push(p), g.push(l);
          return g;
        }
        function te(o) {
        ...
        function x(o, i, a, l) {
          for (var p = 0; p < l && !(p + a >= i.length || p >= o.length); ++p) i[p + a] = o[p];
          return p;
        }
        function Oe(o) {
          return o !== o;
                ...
                isNaN(u) || u === 1 / 0
                  ...
                  : ((C = Math.floor(Math.log(u) / Math.LN2)),
                    ...
                    C + j >= E
                      ...
                      : ((h = u * Math.pow(2, j - 1) * Math.pow(2, O)), (C = 0)));
              O >= 8;
              H[e + w] = h & 255, w += ce, h /= 256, O -= 8
            );
            for (C = (C << O) | h, T += O; T > 0; H[e + w] = C & 255, w += ce, C /= 256, T -= 8);
            H[e + w - ce] |= q * 128;
          });
      },
      18589: function (Le, I) {
...
`,
          ...
          Ie = (function () {
            ...
            return (
              ...
              (O.prototype.indexForLocation = function (X) {
                var C = X.line,
                  h = X.column;
                return C < 0 || C >= this.offsets.length || h < 0 || h > this.lengthOfLine(C)
                  ? null
                  : this.offsets[C] + h;
              }),
              (O.prototype.lengthOfLine = function (X) {
                var C = this.offsets[X],
                  h = X === this.offsets.length - 1 ? this.string.length : this.offsets[X + 1];
                return h - C;
              }),
              O
            );
      ...
      41074: function (Le, I, H) {
        ...
        var u =
          ...
          function () {
            ...
            for (var j = Array(d), r = 0, T = 0; T < E; T++)
              for (var w = arguments[T], ce = 0, q = w.length; ce < q; ce++, r++) j[r] = w[ce];
            return j;
          };
        ...
        function C() {
          ...
          for (
            var E = Object.assign.apply(Object, u([{}, e.basicTypes], d)), j = {}, r = 0, w = d;
            r < w.length;
            r++
          )
            for (var ce = w[r], q = 0, oe = Object.keys(ce); q < oe.length; q++) {
              var ie = oe[q];
              j[ie] = new h(E, ce[ie]);
            }
          return j;
        ...
        var h = (function () {
          ...
          return (
            ...
            (d.prototype._getMethod = function (T) {
              var E = this.props.get(T);
              if (!E) throw new Error('Type has no property ' + T);
              if (!(E instanceof e.TFunc)) throw new Error('Property ' + T + ' is not a method');
              return E;
            }),
            d
          );
      ...
      22746: function (Le, I, H) {
        ...
        var E = (function (b) {
          ...
          function S(L) {
            var D = b.call(this) || this;
            return (
              (D.value = L), (D.name = JSON.stringify(L)), (D._failMsg = 'is not ' + D.name), D
            );
          }
          return (
        ...
        var r = (function (b) {
          ...
          return (
            (S.prototype.getChecker = function (L, D) {
              ...
              return function (ae, _) {
                if (!Array.isArray(ae)) return _.fail(null, 'is not an array', 0);
          ...
          return (
            (S.prototype.getChecker = function (L, D) {
              var z = this.ttypes.map(function (_) {
                ...
                ae = function (_, me) {
                  if (!Array.isArray(_)) return me.fail(null, 'is not an array', 0);
        ...
        var oe = (function (b) {
          ...
          function S(L) {
            ...
            return (
              z.length
                ? (ae > 0 && z.push(ae + ' more'), (D._failMsg = 'is none of ' + z.join(', ')))
        ...
        var Ce = (function (b) {
          ...
          function S(L, D) {
            ...
            return (z.enumName = L), (z.prop = D), (z._failMsg = 'is not ' + L + '.' + D), z;
          }
          return (
            (S.prototype.getChecker = function (L, D) {
              var z = this,
            ...
            (S.prototype.getChecker = function (L, D, z) {
              var ae = this,
                ...
                te = function (Oe, o) {
                  ...
                  for (var i = 0; i < _.length; i++) if (!_[i](Oe, o)) return !1;
              ...
              return (
                ...
                function (Oe, o) {
                  if (!te(Oe, o)) return !1;
                  for (var i in Oe) if (!x.has(i)) return o.fail(i, 'is extraneous', 2);
                  return !0;
                }
              );
            }),
          ...
          return (
            (S.prototype.getChecker = function (L, D) {
              return function (z, ae) {
                return typeof z == 'function' ? !0 : ae.fail(null, 'is not a function', 0);
              };
            }),
            S
          );
          ...
          return (
            (S.prototype.getChecker = function (L, D) {
              var z = this,
                ...
                Re = function (Q, te) {
                  if (!Array.isArray(Q)) return te.fail(null, 'is not an array', 0);
      ...
      67180: function (Le, I) {
        ...
        var Ie = (function () {
          ...
          return (
            (X.prototype.fail = function (C, h, d) {
              return this._propNames.push(C), this._messages.push(h), (this._score += d), !1;
            }),
            (X.prototype.unionResolver = function () {
              return new O();
            }),
            (X.prototype.resolveUnion = function (C) {
              for (var h, d, T = C, E = null, j = 0, r = T.contexts; j < r.length; j++) {
                var w = r[j];
