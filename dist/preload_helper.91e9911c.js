      ...
      i = (function (t, e, n) {
        ...
        n,
        {
          ...
          f: [
            ...
            ['empty__index.md.09ff4550.async.js', 949],
          ],
          r: {
            '/*': [4, 5, 6, 7, 25, 40],
            '/': [41, 6, 7, 25, 40],
            '/components': [22, 6, 7, 25, 40],
            '/directives': [23, 6, 7, 25, 40],
            '/dev-tools': [21, 6, 7, 25, 40],
            '/js-tools': [13, 6, 7, 25, 40],
            '/guide': [36, 6, 7, 25, 40],
            '/~demos/:id': [2, 3, 40],
            '/js-tools/string-format-file-size': [12, 6, 7, 25, 40],
            '/js-tools/string-parse-url-params': [24, 6, 7, 25, 40],
            '/js-tools/string-thousand-format': [9, 6, 7, 25, 40],
            '/js-tools/array-deep-search-all': [26, 6, 7, 25, 40],
            '/js-tools/object-obj2-form-data': [28, 6, 7, 25, 40],
            '/directives/define-directive': [8, 6, 7, 25, 40],
            '/js-tools/cache-session-cache': [37, 6, 7, 25, 40],
            '/js-tools/event-event-emitter': [16, 6, 7, 25, 40],
            '/js-tools/string-random-color': [1, 6, 7, 25, 40],
            '/js-tools/window-full-screen': [27, 6, 7, 25, 40],
            '/components/theme-provider': [15, 6, 7, 25, 40],
            '/js-tools/array-deep-search': [34, 6, 7, 25, 40],
            '/js-tools/cache-local-cache': [18, 6, 7, 25, 40],
            '/js-tools/base-is-data-type': [29, 6, 7, 25, 40],
            '/js-tools/window-copy-text': [39, 6, 7, 25, 40],
            '/directives/r-permission': [17, 6, 7, 25, 40],
            '/js-tools/file-download': [19, 6, 7, 25, 40],
            '/js-tools/file-html2-pdf': [14, 6, 7, 25, 40],
            '/js-tools/window-scroll': [31, 6, 7, 25, 40],
            '/js-tools/array-uniq-by': [30, 6, 7, 25, 40],
            '/js-tools/event-sleep': [20, 6, 7, 25, 40],
            '/js-tools/object-omit': [10, 6, 7, 25, 40],
            '/js-tools/object-pick': [32, 6, 7, 25, 40],
            '/js-tools/string-uuid': [11, 6, 7, 25, 40],
            '/js-tools/base-clone': [33, 6, 7, 25, 40],
            '/js-tools/string-tm': [35, 6, 7, 25, 40],
            '/js-tools/validates': [0, 6, 7, 25, 40],
            '/directives/r-if': [38, 6, 7, 25, 40],
            '/components/empty': [42, 6, 7, 25, 40],
          },
        },
        { publicPath: '/' },
      );
